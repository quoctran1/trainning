...
class BodyTicketCustomPainter extends StatelessWidget {
  const BodyTicketCustomPainter({super.key});
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                    child: itemWidget(title: 'Airline', content: 'Air Asia')),
                Expanded(
                    child: itemWidget(
                        title: 'Passengers', content: 'James Christin')),
              ],
            ),
            const SizedBox(
              height: 20,
            ...
            Row(
              children: [
                Expanded(
                    child: itemWidget(title: 'Date', content: '24 Mar 2020')),
                Expanded(
                    child: itemWidget(
                        title: 'Gate',
                        content: '24A',
            ...
            Row(
              children: [
                Expanded(
                    child:
                        itemWidget(title: 'Boarding Time', content: '02:39pm')),
                Expanded(
                    child: itemWidget(
                        title: 'Seat',
                        content: '5A',
...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_1_fill.color = const Color(0xffD8D8D8).withOpacity(1.0);
    ...
    paint_2_fill.color = const Color(0xffD8D8D8).withOpacity(1.0);
